...
-- 결과: 0~1%(제로금리) 평균 0.0774% / 1~3%(저금리) 0.0467% / 3~5%(중금리) 0.0764% / 5%+(고금리) 0.1242%
-- 고금리(5%+) 구간에서 평균 수익률이 가장 높음(0.1242%). 다만 변동성은 3~5%(중금리) 구간이 가장 높고(1.7669), 고금리 구간 변동성(1.0737)은 상대적으로 낮은 편
-- 거래일 분포가 극단(제로금리 기간 2349일 vs 중금리 기간 125일)에 몰려있어 금리 수준 단독으로는 뚜렷한 패턴 확인 어려움
